    ...
    <section class="card section">
      ...
      <ul>
        <li>
          ...
          Os tiers são calculados a partir da mediana (ou p95) de DPS/HPS de cada spec
      ...
      <p>
        ...
        <strong>mediana</strong> de todos os parses registrados (ou o <strong>percentil 95</strong>
      ...
      <h2>Como o BIS é calculado</h2>
      <p>
        Cada item recebe uma pontuação somando seus atributos multiplicados pelos pesos
        oficiais da spec no BisBeard (incluindo DPS da arma), respeitando as permissões de
        armadura e arma de cada classe. Itens de PvP são excluídos. O resultado é o top de
        itens da Fase 1 por slot.
      </p>
      <p class="disclaimer">
...
export class AboutComponent {
  constructor(title: Title) {
    title.setTitle('Sobre — CoA Tier List');
  }
}
